    ...
    <div className="fixed w-full top-0 left-0 z-50 glass-morphism backdrop-blur-lg bg-gray-900/80 shadow-lg animate-fade-in">
      <div className="flex justify-between items-center h-20 max-w-7xl mx-auto px-6 text-white">
        ...
        <div
          className={
            nav
              ? "absolute right-0 top-20 w-full glass-morphism-dark shadow-xl transition-all duration-300 ease-in-out transform origin-top md:hidden"
              : "absolute right-0 top-20 w-full transform scale-y-0 opacity-0 transition-all duration-300 ease-in-out origin-top md:hidden"
          }
        >
          <ul className="py-4">
